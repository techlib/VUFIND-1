        ...
        success: function(transaction) {
            ...
            if (options) {
                ...
                for (i=0; i<options.length; i++) {
                    ...
                    if (nextElem) {
                        responseHTML += '<li>' +
                                        '<a style="float: right; font-size:70%;" href="' + path + '/Search/Results?lookfor=%22' + encodeURIComponent(facetText) + '%22&type=' + field + '&filter[]=' + query + '">' + NTK.translate("View Records") + '</a>' +
        ...
        success: function(transaction) {
            ...
            if (options) {
                ...
                for (i=0; i<options.length; i++) {
                    ...
                    var facetCount = options[i][1];
                    responseHTML += '<li>' +
                                    '<a style="float: right; font-size:70%;" href="' + path + '/Search/Results?lookfor=%22' + encodeURIComponent(facetText) + '%22&type=' + field + '">' + NTK.translate("View Records") + '</a>' +
