      ...
      <b class="btop"><b></b></b>
        <div class="toolbar">
          <ul>
            ...
            {* TODO: implement texting <li><a href="{$url}/Summon/SMS?id={$id|escape:"url"}" class="sms" onClick="getLightbox('Summon', 'SMS', '{$id|escape}', null, '{translate text="Text this"}'); return false;">{translate text="Text this"}</a></li> *}
