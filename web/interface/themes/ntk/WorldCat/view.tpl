      ...
      <b class="btop"><b></b></b>
        ...
        {* Display Book Cover *}
            ...
            <div class="alignright">
                <a href="{$path}/bookcover.php?isn={$isbn|@formatISBN}&amp;size=large&amp;id={$id}">
                    <img alt="{translate text='Book Cover'}" class="recordcover" src="{$path}/bookcover.php?isn={$isbn|@formatISBN}&amp;size=medium&amp;id={$id}">
                </a>
            </div>
            {else}
